...
- Développeur (opérateur télécom Sewan)
- Doctorant en philosophie politique et de la technique:
    comparaison des critiques de la technologie chez les hackers et les écologistes
- Formateur: Linux, Docker, Ansible
...
- Tout faire avec la ligne de commande
- Ubuntu, une distribution classique et conviviale
...
...Expansion de l'informatique, réduction de ses machines...
...
Note: Un exemple d'une machine de la fin des années 60. Un minicomputer
...
- `r` : lire (Read) le fichier
- `w` : écrire (Write) dans le fichier
- `x` : executer (eXecute) le fichier
